...
export const metadata: Metadata = {
  ...
  description: "Optimise ton profil LinkedIn en 5 minutes. Analyse complète de ton profil et axes d'amélioration pour transformer tes likes en clients. Un outil conçu à partir de l'analyse de plus de 500 profils LinkedIn.",
  icons: {
